...
<div class="container">
    ...
    <table>
        ...
        <?php
        while ($row = mysqli_fetch_assoc($result_loss)) {
            echo "<tr>
                <td>{$row['name']}</td>
                <td>{$row['buyprice']}</td>
                <td>{$row['soldprice']}</td>
